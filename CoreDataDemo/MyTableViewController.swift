...
class MyTableViewController: UITableViewController {
    ...
    @IBAction func addMovie(_ sender: UIBarButtonItem) {
       ...
       /* var movie4 = MovieClass(title: "Movie \
            (counter)" , releaseDate: 2014 , rate: 7.0)
        ...
        */
        ...
        movie.setValue(2008, forKey: "releaseDate")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        /*var movie = MovieClass(title: "Movie1", releaseDate: 2000, rate: 5.0)
        var movie2 = MovieClass(title: "Movie2", releaseDate: 2008, rate: 4.0)
        var movie3 = MovieClass(title: "Movie3", releaseDate: 2004, rate: 6.0)
 */
       /* movies.append(movie)
